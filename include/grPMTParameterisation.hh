...
//
//
/// \file grPMTParameterisation.hh
/// \brief Definition of the grPMTParameterisation class

#ifndef grPMTParameterisation_h
#define grPMTParameterisation_h 1
...
class grPMTParameterisation : public G4VPVParameterisation
{
  public:

    grPMTParameterisation(G4int    nBarX, //number of bars in layer, X axis
