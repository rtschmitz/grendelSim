...
enum grTrackStatus { active=1, hitPMT=2, absorbed=4, boundaryAbsorbed=8,
                      inactive=14};
...
class grUserTrackInformation : public G4VUserTrackInformation
{
public:
