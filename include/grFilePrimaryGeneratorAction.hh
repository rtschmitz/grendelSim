...
// ********************************************************************
//
// $Id: grFilePrimaryGeneratorAction.hh 68058 2013-03-13 14:47:43Z gcosmo $
//
/// \file grFilePrimaryGeneratorAction.hh
/// \brief Definition of the grFilePrimaryGeneratorAction class

#ifndef grFilePrimaryGeneratorAction_h
#define grFilePrimaryGeneratorAction_h 1
...
class G4ParticleGun;
class G4Event;
class grPrimaryGeneratorMessenger;
...
class grFilePrimaryGeneratorAction : public G4VUserPrimaryGeneratorAction
{
public:
  grFilePrimaryGeneratorAction(const boost::property_tree::ptree pt, G4int eventOffset);
  virtual ~grFilePrimaryGeneratorAction();
...
private:
  ...
  grPrimaryGeneratorMessenger* fGunMessenger; //messenger of this class
