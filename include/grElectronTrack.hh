...
#include "TVector3.h"
//==============================================================================
class grElectronTrack: public TObject {
public:
  grElectronTrack();
  ClassDef(grElectronTrack,9);
  ~grElectronTrack();
   const grElectronTrack& operator=(const grElectronTrack &right);
     Int_t operator==(const grElectronTrack&) const;
...
//  Double_t GetLastPositionZ()const{ return finalPositionZ_m; }
  ...
  static bool compareHits(grElectronTrack* const &a, grElectronTrack* const &b);
...
typedef std::vector<grElectronTrack*> grElectronTrackVector;
