...
#ifndef grBarParameterisation_h
#define grBarParameterisation_h 1
...
class grBarParameterisation : public G4VPVParameterisation
{
  public:

    grBarParameterisation(G4int    nBarX, //number of bars in layer, X axis
