...
#include "TVector3.h"
//==============================================================================
class mqMCPTrack: public TObject {
public:
	mqMCPTrack();
	ClassDef(mqMCPTrack,9);
	~mqMCPTrack();
	 const mqMCPTrack& operator=(const mqMCPTrack &right);
     Int_t operator==(const mqMCPTrack&) const;
	...
	static bool compareHits(mqMCPTrack* const &a, mqMCPTrack* const &b);
...
typedef std::vector<mqMCPTrack*> mqMCPTrackVector;
