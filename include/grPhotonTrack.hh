...
#include "TVector3.h"
//==============================================================================
class grPhotonTrack: public TObject {
public:
   grPhotonTrack();
  ClassDef(grPhotonTrack,9);
  ~grPhotonTrack();
   const grPhotonTrack& operator=(const grPhotonTrack &right);
     Int_t operator==(const grPhotonTrack&) const;
  ...
  static bool compareHits(grPhotonTrack* const &a, grPhotonTrack* const &b);
  //friend std::ostream& operator<<(std::ostream &o,
  //    grPhotonTrack const &track);
...
typedef std::vector<grPhotonTrack*> grPhotonTrackVector;
