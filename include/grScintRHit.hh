...
class grScintRHit : public TObject
{
  public:

    grScintRHit();
    ~grScintRHit();
    grScintRHit(const grScintRHit&);
    const grScintRHit& operator=(const grScintRHit&);
    Int_t operator==(const grScintRHit&) const;
...
//    Double_t GetTrackLength()const{ return trackLength_cm; };
  ...
  private:
    ...
    ClassDef(grScintRHit,11);

};

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
typedef std::vector<grScintRHit*> grScintRHitVector;
