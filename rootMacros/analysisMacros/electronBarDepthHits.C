...
//  }
  fileDir="/media/ryan/Storage/computing/milliQanFullSim/data/electronEDepSpectrum/MilliQan.root";
  rootEvents.Add(fileDir);
//  TString xTitle = "Number of Detections for 3-Bar-Hit Electrons";
...
TH1I* hNumBarsHit = new TH1I("hNumBarsHit","Bar Hit Depth (all hits), electrons",20,-1.5,18.5);
...
hHitDepthNPE[0]->SetTitle("Hit Depth nPE Spectra, electron");
