...
FOURVEC_TAG = "v8_v1_save2m_skim0p25m"
SIM_TAG = "mcpData_v4"
NTUPLE_TAG = "v5"
exec_path = "condor_exe.sh"
tar_path = "input.tar.gz"
txt_dir = "/hadoop/cms/store/user/bemarsh/milliqan/milliq_mcgen/mcp_txt/{0}".format(FOURVEC_TAG)
input_dir = "/hadoop/cms/store/user/ryan/beammcp_v3/mcp_{0}_{1}".format(FOURVEC_TAG, SIM_TAG)
hadoop_path = "milliqan/milliq_mcgen/geant_ntuples/calibtoys_{0}_{1}".format(FOURVEC_TAG, SIM_TAG)
