...
init = linecache.getline('/homes/schmitz/milliQanFullSim/rootMacros/rootMac/unfinishedlowmid.txt',jobNumber)
read = init.split()
mass = read[0]
charge = read[1]
filen = read[2]
...
outputdir = '/net/cms27/cms27r0/schmitz/mcpSignal_fullsim/hadoop/cms/store/user/ryan/beammcp_fullSim_v1/mcp_v8_v1_save2m_full_fullSim_v1/newdata_lowmidmass/'
