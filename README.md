...
The upper tunnel tracker consists of two tracker stations. The wall-adjacent station begins 1 mm from the tunnel wall, preserving the previous wall clearance. Each station contains a 1.5 cm phi-segmented scintillator plane, a 1 mm air gap, and a 1.5 cm longitudinally segmented scintillator plane, for a 3.1 cm envelope. The clear distance from the inward face of the wall station to the wall-facing face of the second station is exactly 24 cm. Both orientations use alternating triangular strips with a nominal 3 cm base, 1.5 cm height, and 1.5 cm center-to-center pitch. The longitudinal strips reuse four solid definitions (the two alternating shapes and two end caps) across explicit placements inside a dedicated shell envelope. Around the curved arch, strip boundaries are laid out by arc length and follow the local tunnel normal; terminal half-strips close both ends without gaps.
