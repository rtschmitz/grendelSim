...
// ********************************************************************
//
/// \file exoticphysics/monopole/src/grMonopoleFieldSetup.cc
/// \brief Implementation of the grMonopoleFieldSetup class
//
// $Id: grMonopoleFieldSetup.cc 68036 2013-03-13 14:13:45Z gcosmo $
//
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//
//
// grMonopoleFieldSetup is responsible for setting up a magnetic field
...
#include "grMonopoleFieldMessenger.hh"
...
grMonopoleFieldSetup* grMonopoleFieldSetup::fMonopoleFieldSetup=0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

grMonopoleFieldSetup::grMonopoleFieldSetup()
  : fFieldManager(0),
    fChordFinder(0),
    fEquation(0),
    fMonopoleEquation(0),
...
{
  fMonopoleFieldMessenger = new grMonopoleFieldMessenger(this);

}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

grMonopoleFieldSetup* grMonopoleFieldSetup::GetMonopoleFieldSetup()
{

  if (0 == fMonopoleFieldSetup)
    {
      static grMonopoleFieldSetup theInstance;
...
void grMonopoleFieldSetup::SetMagField(G4double fieldValueX, G4double fieldValueY, G4double fieldValueZ)
{
...
void
grMonopoleFieldSetup::InitialiseAll()
{
  fFieldManager = /*new G4FieldManager();*/G4TransportationManager::GetTransportationManager()
    ->GetFieldManager();

  fEquation = new G4Mag_UsualEqRhs(fMagneticField);
  G4ElectroMagneticField* fEMField = (G4ElectroMagneticField*)fMagneticField;
  //fMonopoleEquation = new grMonopoleEquation(fMagneticField);
  fMonopoleEquation = new grMonopoleEquation(fEMField);
...
void grMonopoleFieldSetup::SetStepperAndChordFinder(G4int val)
{
  if (fMagneticField)
    {
      fFieldManager->SetDetectorField(fMagneticField );
...
G4FieldManager*  grMonopoleFieldSetup::GetGlobalFieldManager()
{
