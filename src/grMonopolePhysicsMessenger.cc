...
// ********************************************************************
//
/// \file exoticphysics/monopole/src/grMonopolePhysicsMessenger.cc
/// \brief Implementation of the grMonopolePhysicsMessenger class
//
// $Id: grMonopolePhysicsMessenger.cc 68036 2013-03-13 14:13:45Z gcosmo $
//
...
grMonopolePhysicsMessenger::grMonopolePhysicsMessenger(grMonopolePhysics* p)
  : G4UImessenger(),
    fPhys(p),
    fPhysicsDir(0),
    fPhysicsCmd(0),
...
grMonopolePhysicsMessenger::~grMonopolePhysicsMessenger()
{
  delete fPhysicsCmd;
  delete fMCmd;
  delete fZCmd;
...
void grMonopolePhysicsMessenger::SetNewValue(G4UIcommand* command,
             G4String newValue)
{
