...
// ********************************************************************
//
/// \file field/field03/src/grPrimaryGeneratorMessenger.cc
/// \brief Implementation of the grPrimaryGeneratorMessenger class
//
//
// $Id: grPrimaryGeneratorMessenger.cc 77892 2013-11-29 08:56:08Z gcosmo $
//
//
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

#include "../include/grPrimaryGeneratorMessenger.hh"
...
G4ParticleDefinition*  grFilePrimaryGeneratorAction::fgPrimaryParticle = 0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

grPrimaryGeneratorMessenger::grPrimaryGeneratorMessenger(
                 grFilePrimaryGeneratorAction* action)
  : G4UImessenger(),
    fAction(action),
    fRndmCmd(0),
    fSetXVertexCmd(0),
...
void grPrimaryGeneratorMessenger::SetNewValue(G4UIcommand * command,
              G4String newValue)
{
  if( command == fRndmCmd )
