...
// ********************************************************************
//
/// \file exoticphysics/monopole/src/MilliQMonopolePhysicsMessenger.cc
/// \brief Implementation of the MilliQMonopolePhysicsMessenger class
//
// $Id: MilliQMonopolePhysicsMessenger.cc 68036 2013-03-13 14:13:45Z gcosmo $
//
...
MilliQMonopolePhysicsMessenger::MilliQMonopolePhysicsMessenger(MilliQMonopolePhysics* p)
  : G4UImessenger(),
    fPhys(p), 
    fPhysicsDir(0),    
    fPhysicsCmd(0),
...
MilliQMonopolePhysicsMessenger::~MilliQMonopolePhysicsMessenger()
{
  delete fPhysicsCmd;
  delete fMCmd;
  delete fZCmd;
