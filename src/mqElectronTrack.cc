...
ClassImp(mqElectronTrack)

//==============================================================================

mqElectronTrack::mqElectronTrack() :
			trackID(-1),
...
const mqElectronTrack& mqElectronTrack::operator=(const mqElectronTrack &right){
...
Int_t mqElectronTrack::operator==(const mqElectronTrack& right) const
{
...
bool mqElectronTrack::compareHits(mqElectronTrack* const &a, mqElectronTrack* const &b){
