...
grShieldingList::grShieldingList( G4int verbose, G4String LEN_model, const boost::property_tree::ptree pt)
{
  ...
  //Monopole Physics
  grMonopolePhysics* MonopolePhys = new grMonopolePhysics(pt);
...
grShieldingList::~grShieldingList()
{
}

void grShieldingList::SetCuts()
{
