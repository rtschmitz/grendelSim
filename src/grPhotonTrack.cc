...
const grPhotonTrack& grPhotonTrack::operator=(const grPhotonTrack &right){
...
Int_t grPhotonTrack::operator==(const grPhotonTrack& right) const
{
...
bool grPhotonTrack::compareHits(grPhotonTrack* const &a, grPhotonTrack* const &b){
