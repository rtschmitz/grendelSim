...
// ********************************************************************
//
// $Id: grFilePrimaryGeneratorAction.cc 68058 2013-03-13 14:47:43Z gcosmo $
//
/// \file grFilePrimaryGeneratorAction.cc
/// \brief Implementation of the grFilePrimaryGeneratorAction class
...
#include "grPrimaryGeneratorMessenger.hh"
...
//#include "grMonopole.hh"
//#include "grMonopolePhysics.hh"
//#include "G4Electron.hh"


//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4int grFilePrimaryGeneratorAction::neventLHE = 0;
G4bool grFilePrimaryGeneratorAction::firstPass = true;
std::vector<std::vector<G4double> >  grFilePrimaryGeneratorAction::vertexList;
std::vector<std::vector<G4double> >  grFilePrimaryGeneratorAction::momentumList;
std::vector<std::vector<G4double> >  grFilePrimaryGeneratorAction::qmeList;
//std::vector<G4double>                   grFilePrimaryGeneratorAction::eventWeight;

grFilePrimaryGeneratorAction::grFilePrimaryGeneratorAction(const boost::property_tree::ptree pt, G4int eventOffset) :
  ...
  fGunMessenger = new grPrimaryGeneratorMessenger(this);
  ...
  try {
    ...
    G4Exception("grFilePrimaryGeneratorAction::PrimaryGeneratorAction()", "ConfigFileReadError", FatalException, msg);
  }
...
grFilePrimaryGeneratorAction::~grFilePrimaryGeneratorAction() {
  delete fParticleGun;
...
void grFilePrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent) {
...
*/
 ...
 //grUserEventInformation* eventInformation = (grUserEventInformation*)anEvent->GetUserInformation();
...
G4String grFilePrimaryGeneratorAction::GetPrimaryName() {
  return fgPrimaryParticle->GetParticleName();
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void grFilePrimaryGeneratorAction::SetXVertex(G4double x) {
  fVertexDefined = true;
  fXVertex = x;
...
void grFilePrimaryGeneratorAction::SetYVertex(G4double y) {
  fVertexDefined = true;
  fYVertex = y;
...
void grFilePrimaryGeneratorAction::SetZVertex(G4double z) {
  fVertexDefined = true;
  fZVertex = z;
...
void grFilePrimaryGeneratorAction::SetMomentumXVertex(G4double x) {
  fVertexDefined = true;
  fMomentumXVertex = x;
...
void grFilePrimaryGeneratorAction::SetMomentumYVertex(G4double y) {
  fVertexDefined = true;
  fMomentumYVertex = y;
...
void grFilePrimaryGeneratorAction::SetMomentumZVertex(G4double z) {
  fVertexDefined = true;
  fMomentumZVertex = z;
...
void grFilePrimaryGeneratorAction::SetCalibEnergy(G4double e) {
  fCalibDefined = true;
  fEnergy = e;
...
void grFilePrimaryGeneratorAction::GetLHEFourVectors() {
  std::ifstream infile;
...
//pencil beam
    ...
    grFilePrimaryGeneratorAction::vertexList.push_back( Tver );
