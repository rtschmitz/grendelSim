...
// ********************************************************************
//
/// \file exoticphysics/monopole/src/grMonopolePhysics.cc
/// \brief Implementation of the grMonopolePhysics class
//
// $Id: grMonopolePhysics.cc 68036 2013-03-13 14:13:45Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   grMonopolePhysics
//
...
#include "grMonopolePhysicsMessenger.hh"
...
//#include "grMonopoleTransportation.hh"
...
grMonopolePhysics::grMonopolePhysics(const boost::property_tree::ptree pt,const G4String& nam)
    ...
    fPTree(pt), fMessenger(0), fMpl(0)
{
  ...
  try {
    ...
    G4Exception("grMonopolePhysics::grMonopolePhysics()", "MilliMonopolePhysics::ConfigFileReadError", FatalException, msg);
  }
  ...
  fMessenger = new grMonopolePhysicsMessenger(this);
  SetPhysicsType(bUnknown);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

grMonopolePhysics::~grMonopolePhysics()
{
  delete fMessenger;
}
...
void grMonopolePhysics::ConstructParticle()
{
  fMpl = grMonopole::MonopoleDefinition(fMonopoleMass, fMagCharge, fElCharge);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void grMonopolePhysics::ConstructProcess()
{
  if(verboseLevel > 0) {
    G4cout << "grMonopolePhysics::ConstructProcess" << G4endl;
  }
...
void grMonopolePhysics::SetMagneticCharge(G4double val)
{
  fMagCharge = val;
}
...
void grMonopolePhysics::SetElectricCharge(G4double val)
{
  fElCharge = val;
}
...
void grMonopolePhysics::SetMonopoleMass(G4double mass)
{
