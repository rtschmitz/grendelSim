...
ClassImp(grScintRHit)
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

grScintRHit::grScintRHit():
...
grScintRHit::grScintRHit(const grScintRHit& right):
...
const grScintRHit& grScintRHit::operator=(const grScintRHit& right)
{
    trackID         = right.trackID        ;
    parentID        = right.parentID       ;
    EDep_MeV        = right.EDep_MeV          ;
...
Int_t grScintRHit::operator==(const grScintRHit& right) const
{
