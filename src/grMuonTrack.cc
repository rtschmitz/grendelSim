...
const grMuonTrack& grMuonTrack::operator=(const grMuonTrack &right){
...
Int_t grMuonTrack::operator==(const grMuonTrack& right) const
{
...
bool grMuonTrack::compareHits(grMuonTrack* const &a, grMuonTrack* const &b){
