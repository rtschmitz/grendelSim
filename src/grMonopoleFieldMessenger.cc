...
// ********************************************************************
//
// $Id: grMonopoleFieldMessenger.cc 68036 2013-03-13 14:13:45Z gcosmo $
//
/// \file exoticphysics/monopole/src/grMonopoleFieldMessenger.cc
/// \brief Implementation of the grMonopoleFieldMessenger class
//
//
...
grMonopoleFieldMessenger::grMonopoleFieldMessenger(grMonopoleFieldSetup * fld)
  :G4UImessenger(),
   fField(fld),
   fFieldDir(0),
   fSetFieldCmd(0)
...
grMonopoleFieldMessenger::~grMonopoleFieldMessenger()
{
  delete fSetFieldCmd;
  delete fFieldDir;
}
...
void grMonopoleFieldMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{
